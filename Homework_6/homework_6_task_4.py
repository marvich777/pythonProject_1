...
volkswagen = SportCar(100, 'Gray', 'Volkswagen', False)
daewoo = TownCar(30, 'Black', 'Daewoo', False)
chevrolet = WorkCar(70, 'Gold', 'Chevrolet', True)
ford = PoliceCar(110, 'Blue',  'Ford', True)
print(chevrolet.turn_left())
print(f'When {daewoo.turn_right()}, then {volkswagen.stop()}')
print(f'{chevrolet.go()} with speed exactly {chevrolet.show_speed()}')
print(f'{chevrolet.name} is {chevrolet.color}')
print(f'Is {volkswagen.name} a police car? {volkswagen.is_police}')
